...
@section('content')
            ...
            <div class="kyc-app wide-sm m-auto">
                <div class="nk-block-head nk-block-head-lg wide-xs mx-auto">
                    <div class="nk-block-head-content text-center">
                        <h2 class="nk-block-title fw-normal theme--text">Bắt đầu xác minh danh tính của bạn </h2>
                        <div class="nk-block-des">
                            <p class="theme--text">Để tuân thủ quy định, mỗi người tham gia sẽ phải trải qua quá trình xác
                                minh danh tính
                ...
                @endif
                <div class="nk-block">
                    <div class="card card-bordered dark-mode-background">
                        <div class="nk-kycfm">
                            <form action="{{ route('kyc-cccd') }}" method='post' enctype="multipart/form-data">
                                @csrf
                                <div class="nk-kycfm-head">
                                    <div class="nk-kycfm-count theme--text">01</div>
                                    <div class="nk-kycfm-title">
                                        <h5 class="title fz-13 theme--text">Thông tin cá nhận</h5>
                                        <p class="sub-title fz-12 theme--text">Thông tin cá nhân đơn giản của bạn cần thiết
                                            để nhận dạng
                                        </p>
                                    </div>
                                </div>
                                <div class="nk-kycfm-content">
                                    <div class="row g-4">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="form-label-group "><label
                                                        class="form-label fz-13 theme--text">Họ và tên
                                                        <span class="text-danger">*</span></label></div>
                                                <div class="form-control-group"><input type="text" class="form-control form-control-lg" name="full_name" value="{{ old('full_name') }}"></div>
                                                @error('full_name')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="form-label-group"><label class="form-label fz-13 theme--text">Mã
                                                        ID
                                                        (cccd/cmnd...) <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="form-control-group"><input type="text"
                                                        class="form-control form-control-lg" name="id_cccd" value="{{ old('id_cccd') }}">
                                                </div>
                                                @error('id_cccd')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                ...
                                <div class="nk-kycfm-head">
                                    <div class="nk-kycfm-count theme--text">02</div>
                                    <div class="nk-kycfm-title">
                                        <h5 class="title fz-13 theme--text">Tải lên tài liệu
                                        </h5>
                                        <p class="sub-title fz-12 theme--text">Để xác minh danh tính của bạn, vui lòng tải
                                            lên bất kỳ
                                            tài
                                            liệu nào của bạn.</p>
                                    </div>
                                ...
                                <div class="nk-kycfm-content">
                                    ...
                                    <ul class="nk-kycfm-control-list g-3">
                                        <li class="nk-kycfm-control-item"><input class="nk-kycfm-control" type="radio"
                                                name="id-proof" id="passport" data-title="Passport" checked=""><label
                                                class="nk-kycfm-label" for="passport"><span
                                                    class="nk-kycfm-label-icon"><span class="label-icon"><svg
                                                            ...
                                                            <path
                                                                ...
                                                                transform="translate(-3.9995 -2.101)" fill="#6476ff"></path>
                                                        </svg></span></span><span
                                                    class="nk-kycfm-label-text fz-13 theme--text">Passport</span></label>
                                        </li>
                                        <li class="nk-kycfm-control-item"><input class="nk-kycfm-control" type="radio"
                                                name="id-proof" id="national-id" data-title="National ID"><label
                                                class="nk-kycfm-label" for="national-id"><span
                                                    class="nk-kycfm-label-icon"><span class="label-icon"><svg
                                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 76 63">
                                                            <path
                                                                ...
                                                                transform="translate(-2 -8.9898)" fill="#6476ff"></path>
                                                        </svg></span></span><span
                                                    class="nk-kycfm-label-text fz-13 theme--text">Cccd/cmnd</span></label>
                                        </li>
                                        <li class="nk-kycfm-control-item"><input class="nk-kycfm-control" type="radio"
                                                name="id-proof" id="driver-licence" data-title="Driving License"><label
                                                class="nk-kycfm-label" for="driver-licence"><span
                                                    class="nk-kycfm-label-icon"><span class="label-icon"><svg
                                                            ...
                                                            <path
                                                                ...
                                                                transform="translate(-2 -2)" fill="#6476ff"></path>
                                                        </svg></span></span><span
                                                    class="nk-kycfm-label-text fz-13 theme--text">Giấy
                                                    phép
                                                    lái xe</span></label></li>
                                    </ul>

                                    <div class="nk-kycfm-upload">
                                        <h6 class="title nk-kycfm-upload-title fz-12 theme--text">Tải lên mặt trước ảnh Cccd của
                                            bạn</h6>
                                        <div class="row align-items-center">
                                            <div class="col-sm-8">
                                                <div class="nk-kycfm-upload-box">
                                                    <div class="upload-zone dropzone dz-clickable dark-mode-background">
                                                        <span class="dz-message-text" id="id-front"></span>
                                                        <div class="dz-message" data-dz-message="">
                                                            <label class="btn btn-primary" id="id-front-button">
                                                                Chọn
                                                            </label>
                                                            <input name="id_front" accept="image/*" type="file"
                                                                id="id-front-input" style="display: none;" />
                                            ...
                                            <div class="col-sm-4 d-none d-sm-block">
                                                <div class="mx-md-4"><img src="{{ asset('assets/images/id-front.svg') }}"
                                                        alt="ID Front"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-kycfm-upload">
                                        <h6 class="title nk-kycfm-upload-title theme--text">Tải lên mặt sau ảnh Cccd của bạn
                                        </h6>
                                        <div class="row align-items-center">
                                            <div class="col-sm-8">
                                                <div class="nk-kycfm-upload-box">
                                                    <div class="upload-zone dropzone dz-clickable dark-mode-background">
                                                        <span id="id-back" class="dz-message-text"></span>
                                                        <div class="dz-message" data-dz-message="">
                                                            <label class="btn btn-primary" id="uploadButton">Chọn</label>
                                                            <input name="id_back" accept="image/*" type="file"
                                            ...
                                            <div class="col-sm-4 d-none d-sm-block">
                                                <div class="mx-md-4"><img src="{{ asset('assets/images/id-back.svg') }}"
                                                        alt="ID Back">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="nk-kycfm-upload">
                                        <h6 class="title nk-kycfm-upload-title theme--text">Tải lên ảnh chân dung cầm cccd của bạn
                                        </h6>
                                        <div class="row align-items-center">
                                            <div class="col-sm-8">
                                                <div class="nk-kycfm-upload-box">
                                                    <div class="upload-zone dropzone dz-clickable dark-mode-background">
                                                        <span id="id-face" class="dz-message-text"></span>
                                                        <div class="dz-message" data-dz-message="">
                                                            <label class="btn btn-primary"
                                                                id="id-face-button">Chọn</label>
                                                            <input name="id_user" accept="image/*" type="file"
                                                                id="id-face-input" style="display: none;" />
                                                        </div>
                                                        @error('id_user')
                                                            <div class="alert alert-danger">{{ $message }}</div>
                                                        @enderror
                                            ...
                                            <div class="col-sm-4 d-none d-sm-block">
                                                <div class="mx-md-4 div-face"><img class="img-face"
                                                        src="{{ asset('assets/images/kyc-face.jpg') }}" alt="ID Back">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="nk-kycfm-footer">
                                    <div class="form-group">
                                        <div class="custom-control custom-control-xs custom-checkbox"><input
                                                type="checkbox" name="agree" class="custom-control-input"
                                                id="tc-agree"><label class="custom-control-label theme--text"
                                                for="tc-agree">Tôi đã
                                                đọc Điều khoản và Chính
                                                sách bảo mật Quy trình xác minh
                                                </a></label>
                                        </div>
                                        @error('agree')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                    ...
                                    <input class="d-flex " value="" name="account_number" type="hidden"
                                        id="account_number">
                                    <div class="nk-kycfm-action pt-2"><button type="submit"
                                            class="btn btn-lg btn-primary ">Tiến hành xác minh</button></div>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            const myBank = localStorage.getItem("my_bank");
            $('#account_number').val(myBank)
        })
    </script>
@endsection
