...
<div class="container-fluid">
    <div class="page-section">
        ...
        <form method="post" action="{{ route('admin.coin.update',$item->id) }}" enctype="multipart/form-data">
            @method('put')
            @csrf
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nhập tên tiền mã hóa"
                                    name="coin_name"
                                    value="{{ old('coin_name') ? old('coin_name') : $item->coin_name }}">
                                @error('coin_name')
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nhập tên mạng lưới"
                                    name="network_name"
                                    value="{{ old('network_name') ? old('network_name') : $item->network_name }}">
                                @error('network_name')
                                <div class="text text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row mt-2">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <img class="w-50 m-3 img-thumbnail" src="{{ asset('storage/'.$item->image) }}" alt="">
                                @error('image')
                                <div class="text text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card-footer d-flex justify-content-end">
                    <div class="form-actions">
                        ...
                        <input type="submit" class="btn btn-info waves-effect waves-light" value="Cập nhập">
                    </div>
                </div>
            </div>
        </form>
