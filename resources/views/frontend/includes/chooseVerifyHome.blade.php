    ...
    <div class="modal-dialog dialog-choose-verify">
        <div class="modal-content">
            ...
            <div class="modal-body modal-body-choose-verify">
                <input type="radio" checked id="bank-verify" name="fav_language" value="{{ route('verify') }}">
            ...
            <div class="modal-footer">
                <button type="button" id="continue-button-home" class="btn btn-outline-secondary btn-verify">Tiếp
                    tục</button>
            </div>
